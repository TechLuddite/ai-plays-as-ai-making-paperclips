...
This project was built by **TechLuddite** — a technical services director at an MSP with nearly three decades of experience building computers, managing networks and servers, and making security decisions. Programming has always been the one thing deliberately left alone. Batch scripts, VBScript, light PowerShell, and manual code edits for fixes — that's been the extent of it.
